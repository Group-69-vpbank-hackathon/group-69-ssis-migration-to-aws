...
class PostgresWriter(BaseDataWriter):
    ...
    def __init__(self, jdbc_url, table, secret_name=None, batch_size=1000, target_partitions=4):
        self.jdbc_url = jdbc_url
        self.table_name = table
        self.batch_size = int(batch_size) if batch_size else batch_size
        self.target_partitions = int(target_partitions) if target_partitions else target_partitions
